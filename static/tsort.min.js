        ...
        return this.each(function(){
            function q(e){
                for(var b="",d=0;d<=e.length;d++)
                    if(a.isNumeric(e.charAt(d))||"."==e.charAt(d))
                        b+=e.charAt(d);
                    return b
            }
            var h=[], n=[], l=!1, p=[], j=[], r=[], m=[], f, c=a(this), l=!1;
            !0==b.rowspan&&a(c).find("td").each(function(){
                if(void 0!=a(this).attr("rowspan")){
                    var b=a(this).attr("rowspan");a(this).removeAttr("rowspan");
                    for(var c=a(this).parent().index(), d=1;1<b;){
                        switch(a(this).index()){
                            case 0:
                                a(this).clone().prependTo(a(this).parent().parent().children().eq(c+d));
                                break;
                                default:
                                    a(this).clone().insertAfter(a(this).parent().parent().children().eq(c+d).children().eq(a(this).index()-1))}
                                    d++;
                        b--}}});
            0>=b.delay&&(b.delay=1);
            a(c).find("tr:first-child th").each(function(e){
                if(void 0!=b.sortBy)
                    switch(b.sortBy[e]){
                    case "text":
                        case "numeric":
                ...
                if(void 0!=a(this).attr("data-sort"))
                    ...
                    case "text":
                        case "numeric":
                            case "nosort":
                                m[e]= a(this).attr("data-sort");
                                return}
                for(var g=a(c).find("tr:eq(1) td:eq("+e+")").text(),d=0,h=0,f=0;f<=g.length-1;f++)
                    a.isNumeric(g.charAt(f))||","==g.charAt(f)||"."==g.charAt(f)?d++:h++;m[e]=d>h?"numeric":"text"});
            a(c).css("position","relative");
            a(c).find("tr:first-child th").each(function(b){
                "nosort"!=m[b]&&a('<div class="sortArrow"><div class="sortArrowAscending"></div><div class="sortArrowDescending"></div></div>').appendTo(a(this))});
            a(c).find("tr:first-child th").each(function(){
                r.push(a(this).outerWidth(!0))});
            a(c).find("tr td, tr th").each(function(){
                a(this).css({minWidth:r[a(this).index()]})});
            a(c).find("tr").each(function(){
            ...
            a(c).find("tr th").each(function(b){
                "nosort"!=m[b]&&a(this).css("cursor","pointer")});
            a(c).find("tr th").click(function(){
                if(!l&&"nosort"!=m[a(this).index()]){
                    f=a(this).index();
                    0==h.length&&a(c).find("tr").each(function(d){
                        0<d&&a(this).addClass("tsort_id-"+(d-1));
                        a(this).find("td").each(function(c){
                            a(this).is(":first-child")&&(h.push({}),h[h.length-1].id=d-1,h[h.length-1].td=[],h[h.length-1].height=a(this).parent().height());
                            void 0!=a(this).attr("data-sortAs")?h[h.length-1].td.push(a(this).attr("data-sortAs")):
                                void 0!=typeof b.sortAs&&void 0!=b.sortAs[a(this).text()]?h[h.length-1].td.push(b.sortAs[a(this).text()]):
